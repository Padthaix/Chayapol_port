...
export const PROJECTS = [
  ...
  },
  {
    ...
    tags: ["FULL-STACK WEB", "CLIENT PROJECT"],
    title: "PaoTutor Learning Platform",
    desc: "แพลตฟอร์มจำหน่ายคอร์สและเรียนออนไลน์ พร้อมระบบสมาชิก การชำระเงิน และหลังบ้านสำหรับบริหารธุรกิจ",
    link: "https://drive.google.com/drive/folders/1QaihB73Sj4RFRE_lAYoajSgGS3Jultg6?usp=sharing",
    duration: "3 months · Ongoing",
    team: "Solo project",
    role: "Solo developer — ออกแบบและพัฒนาระบบครบทั้งฝั่งผู้เรียนและผู้ดูแลตามความต้องการของลูกค้า",
    overview: "แพลตฟอร์มเรียนออนไลน์แบบครบวงจร ผู้เรียนสามารถเลือกซื้อคอร์ส สมัครสมาชิก ชำระเงิน และเข้าถึงบทเรียนของตนเองได้ พร้อมระบบหลังบ้านสำหรับจัดการคอร์ส คำสั่งซื้อ ผู้ใช้ รายรับ หน้าเว็บไซต์ การแจ้งเตือน และบันทึกการทำงานของระบบ",
    detailTags: ["SOLO DEVELOPER", "CLIENT PROJECT", "E-LEARNING", "E-COMMERCE", "ADMIN DASHBOARD", "CRUD"],
    highlights: [
      "สร้างเส้นทางผู้ใช้ตั้งแต่เลือกคอร์ส ดูรายละเอียด สมัครสมาชิก เข้าสู่ระบบ ตะกร้า และชำระเงิน",
      "พัฒนาพื้นที่ My Courses สำหรับเข้าถึงคอร์สที่ซื้อและจัดการบัญชีผู้ใช้",
      "พัฒนาหลังบ้านสำหรับคอร์ส คำสั่งซื้อ ผู้ใช้ รายรับ หน้า Landing การ Broadcast การตั้งค่า และ System Logs",
    ],
  },
  {
